...
- [OpenAPI](openapi/visa-supplier-matching-service.yml)
...
- [OpenAPI](openapi/card-on-file-data-inquiry.yml)
- [GettingStarted](https://developer.visa.com/capabilities/card-on-file-data-inquiry/docs-getting-started)
...
- [OpenAPI](openapi/foreign-exchange.yml)
...
- [OpenAPI](openapi/payment-account-attributes-inquiry.yml)
- [GettingStarted](https://developer.visa.com/capabilities/paai/docs-getting-started)
...
- [OpenAPI](openapi/visa-account-updater.yml)
...
- [OpenAPI](openapi/visa-business-data-solutions.yml)
...
- [OpenAPI](openapi/visa-data-tokens.yml)
...
- [OpenAPI](openapi/visa-card-program-management.yml)
...
- [OpenAPI](openapi/visa-click-to-pay.yml)
...
- [OpenAPI](openapi/visa-merchant-search.yml)
...
- [OpenAPI](openapi/visa-b2b-connect.yml)
...
- [OpenAPI](openapi/visa-merchant-offers.yml)
- [Documentation](https://developer.visa.com/capabilities/vmorc/docs)

### Visa Offers Platform
Visas Customers can get access to near real-time transaction data via the Visa Offers Platform to execute and manage their card-linked programs. For cardholders who have consented to take part in the Customers program, VOP can access the VisaNet authorization and settlement stream to qualify transactions and send the relevant notifications to the Customer in near real-time. Using the VOP APIs, Customers can leverage capabilities to enhance their own web and mobile applications.
...
- [OpenAPI](openapi/visa-direct.yml)
...
- [OpenAPI](openapi/visa-global-atm-locator.yml)
...
- [OpenAPI](openapi/visa-transaction-controls.yml)
...
- [JSONSchema](json-schema/visa-payment-transaction-schema.json)
- [JSONSchema](json-schema/visa-merchant-schema.json)
- [JSONSchema](json-schema/visa-account-schema.json)
- [JSON-LD](json-ld/visa-context.jsonld)
